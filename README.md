...
**A Safari redirector to control your web.**
...
<p align="center">
Freedirect is a small Safari Web Extension for macOS, iOS, and iPadOS.<br>
...
> [!IMPORTANT]
> This project was heavily inspired as a Safari implementation of [Libredirect](https://github.com/libredirect/browser_extension). If you are coming from Chrome/Firefox and are used to Libredirect, you might notice incomplete feature parity, partly due to Safari limitations and partly due to the early development stage. Feel free to open a feature request if you would like more features added :)
